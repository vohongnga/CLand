            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <img src="{{$publicUrl}}/img/footer-logo.png" alt="">
                        <ul>
    ...
    <script src="{{$publicUrl}}js/jquery.nice-select.min.js"></script>
    <script src="{{$publicUrl}}js/jquery.barfiller.js"></script>
    <script src="{{$publicUrl}}js/jquery.slicknav.js"></script>
    <script src="{{$publicUrl}}js/owl.carousel.min.js"></script>
